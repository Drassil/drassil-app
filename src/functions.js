...
module.exports = {
    ...
    Drassil.fadeInDownloadBar = function()
    {
        $(document).ready(function() {
    ...
    Drassil.fadeOutDownloadBar = function()
    {
        $(document).ready(function() {
    ...
    Drassil.fadeInPlayButton = function()
    {
        $(document).ready(function() {
            $('#play-btn').removeClass('hidden');
    ...
    Drassil.downloadPercentage = function(downloadedMB, totalMB, name, realPercent)
    {
